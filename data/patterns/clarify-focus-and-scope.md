...
Strategies: field → workshop → (library break-out)
...
This pattern is applicable when you are trying to understand the stakeholders and their goals, and when the stakeholders' wishes have not yet fully crystallized. This is usually the case at the very beginning of a project (problem analysis phase).
...
1. Field — What kind of interactive installation does the museum need?
2. Workshop — Create an artifact that makes my ideas discussable
3. Field — What aspects of the artifacts match the needs of the museum?
4. Workshop — Create an artifact that makes my ideas discussable
5. Field — What aspects of the artifacts match the needs of the museum?
6. Library — *Break-out* What ideas from existing applications can help me focus?
...
1. Field — What is the currently used manual process?
2. Workshop — Create a paper prototype of an app to automate this manual process
3. Field — Does my solution fix the problem?
4. Library — *Break-out* Which framework helps me to build this app?

### Mobile Nutrition App

You are asked to create a mobile app that uses a trained algorithm to score the nutrition of food via the camera. To explore what people really need, you organize a hackathon (Workshop) where several teams create throw-away MVPs. At regular intervals, the teams step out of their building process to apply the Human Impact Score (Field) to reflect on how their concepts might influence users' autonomy, health, and lifestyle identity. These reflections feed directly into their design choices. To strengthen their concepts, the teams also conduct a Literature Study (Library) on how people make food choices and what motivates them to change eating behavior. These insights guide iterations on how the app provides feedback (e.g., scoring formats, coaching styles) and ensure that design decisions are grounded in existing knowledge.

1. Workshop — Hackathon: Create MVPs for food-recognition and nutrition scoring.
2. Field — Human Impact Score: What ethical and human impacts emerge from these MVPs?
3. Workshop — Iteration: Adjust MVPs based on ethical reflection.
4. Library — Break-out: What do existing studies on food behavior and lifestyle change tell us?
5. Workshop — Iteration: Refine MVPs with literature insights.
6. Field — Human Impact Score: Re-assess user well-being and lifestyle implications.
